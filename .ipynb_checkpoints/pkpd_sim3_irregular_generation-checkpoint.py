...
from simulated_data import pkpd
from utils.data_utils import load_config, load_tensor
...
base_path_data = "data/{}-p50-seed-".format(sim_id) + str(seed)
...
create_paths(base_path_data_export)
